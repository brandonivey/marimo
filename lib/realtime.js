...
// scoping the realtime module inside a function to avoid the use of this.
var marimo_realtime = {
  name : 'realtime',
  marimo_module : true,
  init: function init () {
   ...
   browsermq: {
      ...
      */
      init: function(data) {
        ...
        this.data = data;
        // and this is why I need scope. this should work for now
        this.socket = marimo.realtime.sockets.get_socket(data.socket_path);
      ...
      subscribe: function(qname){
        ...
        //all of this breaks if the name changes
        marimo.realtime.queues.subscribe(qname, this.socket, handler);
      },
...
marimo.register_module(marimo_realtime);
