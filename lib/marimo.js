...
var event_transport = Object.create(new EventEmitter())
event_transport._past_events = {}
event_transport.seen(evnt) = function() {
    return this._past_events[evnt] ? true : false
}
event_transport.on = function() {
    // move onlist logic here. i would *really* like underscore to be part of
    // marimo. i will discuss with alex.
    this.addListener.call(this. arguments)
}
event_transport.emit = function(evnt) {
    this._past_events[evnt] = true
    this.prototype.emit.call(this, arguments)
}
