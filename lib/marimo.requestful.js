var marimo_requestful = {
    ...
    init: function() {
        ...
        this.batch_request.module = marimo.requestful
        this.widgetlib.requestful_widget.module = marimo.requestful
        this.requests = {}
    },
        ...
        requestful_widget:  marimo.extend(marimo.widgetlib.base_widget, {
            ...
            add_request: function(options) {
                ...
                */
                ...
                if (!this.module.requests[this.murl]) {
                    this.module.requests[this.murl] = Object.create(this.module.batch_request).init(this.murl)
                }
                this.module.requests[this.murl].add(request_data)
            },
